...
import 'package:deyegnose/classes/database.dart';
import 'package:deyegnose/classes/result.dart';
...
//  }
  ...
  void _saveImage({String id}) async {
...
//    await recognizeImageBinary(image);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('dEYEgnose Home'),
      ),
      body: Center(
        child: Stack(
